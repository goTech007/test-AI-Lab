...
import { useBehavioralConflictMetrics } from '@/hooks/useBehavioralConflictMetrics'
...
export default function BehavioralMetricsPanel() {
  const { metrics } = useBehavioralConflictMetrics()
  ...
  const metricItems = [
    ...
    { label: 'Dominance', value: metrics.dominance },
  ]
